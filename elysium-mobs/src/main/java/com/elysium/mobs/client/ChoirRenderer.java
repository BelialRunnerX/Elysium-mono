 ...
 */
public class ChoirRenderer extends MobRenderer<ElysiumMob, ChoirModel<ElysiumMob>> {

    private static final ResourceLocation FALLBACK =
            ResourceLocation.fromNamespaceAndPath("elysiummobs",
                    "textures/entity/choir/choir.png");

    public ChoirRenderer(EntityRendererProvider.Context context) {
        super(context, new ChoirModel<>(context.bakeLayer(
                com.elysium.mobs.client.ElysiumMobLayers.CHOIR)), 1.32F);
    }
