 ...
 */
public class PraetorRenderer extends MobRenderer<ElysiumMob, PraetorModel<ElysiumMob>> {

    private static final ResourceLocation FALLBACK =
            ResourceLocation.fromNamespaceAndPath("elysiummobs",
                    "textures/entity/praetor/praetor.png");

    public PraetorRenderer(EntityRendererProvider.Context context) {
        super(context, new PraetorModel<>(context.bakeLayer(
                com.elysium.mobs.client.ElysiumMobLayers.PRAETOR)), 0.96F);
    }
