 ...
 */
public class ScavengerRenderer extends MobRenderer<ElysiumMob, ScavengerModel<ElysiumMob>> {

    private static final ResourceLocation FALLBACK =
            ResourceLocation.fromNamespaceAndPath("elysiummobs",
                    "textures/entity/scavenger/ragpicker.png");

    public ScavengerRenderer(EntityRendererProvider.Context context) {
        super(context, new ScavengerModel<>(context.bakeLayer(
                com.elysium.mobs.client.ElysiumMobLayers.SCAVENGER)), 0.38F);
    }
