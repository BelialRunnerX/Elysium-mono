 ...
 */
public class WhisperRenderer extends MobRenderer<ElysiumMob, WhisperModel<ElysiumMob>> {

    private static final ResourceLocation FALLBACK =
            ResourceLocation.fromNamespaceAndPath("elysiummobs",
                    "textures/entity/whisper/ashling.png");

    public WhisperRenderer(EntityRendererProvider.Context context) {
        super(context, new WhisperModel<>(context.bakeLayer(
                com.elysium.mobs.client.ElysiumMobLayers.WHISPER)), 0.47F);
    }
